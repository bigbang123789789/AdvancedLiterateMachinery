...
def main():
    ...
    cfg.pretrained_model_file = '/kaggle/working/workspace/sroie_train/checkpoints/epoch=10-f1_linking=0.9260.pt'
    net = get_model(cfg)
    ...
    for fp in tqdm(file_paths):
        with open(fp, 'r') as f:
            ...
            while True:
                ...
                cv2.rectangle(img, tuple(box_father[:2]), tuple(box_father[2:]), color_box, 1)
