...
def get_config(default_conf_file="/kaggle/working/AdvancedLiterateMachinery/DocumentUnderstanding/GeoLayoutLM/configs/finetune_funsd.yaml"):
...
def _get_config_from_cli():
    ...
    cfg_cli={'-f': None, '/root/': {'local/share/jupyter/runtime/kernel-3d59a3c6-2859-41a2-98ae-87f6e52efb95': {'json': None}}}
